<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Detalle.aspx.cs" Inherits="GestionArticulosWeb.Detalle" %>
        ...
        <div class="col" style="width: 50%">
            <div id="carouselExample" class="carousel carousel-dark slide">
                <div class="carousel-inner">
                    ...
                    <%foreach (GestionArticulosWeb.Imagen Img in listaImagenes)
                        {
